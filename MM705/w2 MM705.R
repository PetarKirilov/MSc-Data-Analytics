...
plot(model1$model$AMINO,model1$residuals,main="Residuals vs. Levels")
...
plot(modelT$model$COMPRESS,modelT$residuals,main="Residuals vs. Levels")
...
plot(modelT1$model$COMPRESS,modelT1$residuals,main="Residuals vs. Levels")
qqnorm(modelT1$residuals)
qqline(c(modelT1$residuals))
#normality of assumptions do not hold
...
plot(modelTnot$model$COMPRESS,modelTnot$residuals,main="Residuals vs. Levels")
